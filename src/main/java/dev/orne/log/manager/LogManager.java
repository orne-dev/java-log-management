...
public interface LogManager {
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default Optional<Logger> existsLogger(
            final Logger logger)
    throws LogManagementException {
        return existsLogger(logger.getName());
    }
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default Map<String, Logger> getChildren(
            final Logger parent)
    throws LogManagementException {
        return getChildren(parent.getName());
    }
     ...
     * @param level The name of the new level for the logger
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default void setLevel(
            final String logger,
            final @Nullable Level level)
    throws LogManagementException {
        setLevel(logger, level != null ?  level.getName() : null);
    }
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default List<String> getAppenders(
            final Logger logger)
    throws LogManagementException {
        return getAppenders(logger.getName());
    }

    /**
     * Returns the configuration of the specified appender if exists.
     * 
     ...
     * Returns the configuration of the specified appender if exists.
     * 
     * @param appender The reference to the appender
     * @return The appender configuration, if exists; {@code null} otherwise
     * @throws LogManagementException If an internal error occurs
     */
    ...
    throws LogManagementException {
        return getAppender(appender.getName());
    }
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default void attachAppender(
            final String logger,
            final Appender appender)
    throws LogManagementException {
        attachAppender(logger, appender.getName());
    }
    ...
    throws LogManagementException {
        attachAppender(logger.getName(), appender);
    }
     ...
     * @throws LogManagementException If an internal error occurs
     */
    default void detachAppender(
            final String logger,
            final Appender appender)
    throws LogManagementException {
        detachAppender(logger, appender.getName());
    }

    /**
     * Detach the existing specified appender from the specified logger.
     * 
     * @param logger The logger to detach the appender from
     * @param appender The name of the target appender
     * @throws LoggerNotFoundException If the logger doesn't exist
     * @throws AppenderNotFoundException If the appender doesn't exist
     * @throws UnmanagedAppenderException If the appender cannot be modified
